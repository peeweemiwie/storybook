	...
	[169],
	{
		...
		'./node_modules/@storybook/components/dist/esm/ScrollArea/ScrollArea.js':
			function (
				...
				var ScrollArea = (0,
				_storybook_theming__WEBPACK_IMPORTED_MODULE_6__.zo)(Scroller)(
					function (_ref2) {
					...
					Link = function Link(_ref8) {
						...
						return react.createElement(
							...
							react.createElement(
								...
								children,
								withArrow &&
									react.createElement(icon.P, { icon: 'arrowright' }),
							),
						);
					};
							...
							return (function applyPolished(type, color) {
								return 'darken' === type
									? (0, polished__WEBPACK_IMPORTED_MODULE_10__.m4)(
											''.concat(
												(0, polished__WEBPACK_IMPORTED_MODULE_10__._j)(
													1,
													color,
												),
											),
									...
									? (0, polished__WEBPACK_IMPORTED_MODULE_10__.m4)(
											''.concat(
												(0, polished__WEBPACK_IMPORTED_MODULE_10__.$n)(
													1,
													color,
												),
											),
		...
		'./node_modules/polished/dist/polished.esm.js': function (
			...
			function parseToRgb(color) {
				...
				var normalizedColor = (function nameToHex(color) {
					...
					var normalizedP1 = color.toLowerCase();
					return namedColorMap[normalizedP1]
						? '#' + namedColorMap[normalizedP1]
						: color;
				})(color);
